...
export const ProjectCardLeft = ({title, technologies_text, code_link, description  }) => {
    return(
        <>
...
export const ProjectCardRight = ({title, technologies_text, code_link, description  }) => {
    return(
        <>
        <div className="projectCardContainer">
            <div className="title_container">
