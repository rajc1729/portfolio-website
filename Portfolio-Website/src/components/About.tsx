      ...
      <section id="about">
        ...
        <div className="grid_container">
          <div id="introduction" className="first_card">
            <div className="card_title_container">
              ...
              >
                <g clipPath="url(#clip0)">
                  <path
                    d="M7 6.51672C3.3106 6.51672 0.30896 9.30399 0.30896 12.7298C0.30896 12.8789 0.439299 13 0.599884 13H13.4001C13.5607 13 13.6911 12.8789 13.6911 12.7298C13.6911 9.30396 10.6894 6.51672 7 6.51672Z"
                    fill="#091133"
                  />
                  <path
                    d="M6.99998 5.94296C8.76732 5.94296 10.2 4.61258 10.2 2.97148C10.2 1.33038 8.76732 0 6.99998 0C5.23264 0 3.79993 1.33038 3.79993 2.97148C3.79993 4.61258 5.23264 5.94296 6.99998 5.94296Z"
                    fill="#091133"
                  />
                </g>
                <defs>
            ...
            <div>
              <p className="description">{Data.introductionPara1}</p>
              <p className="description">{Data.introductionPara2}</p>
            </div>
          </div>
                ...
                return (
                  <div className="language" key={key}>
                    <div>
                      ...
                      <p className="language_confidence_level">
                        {languageProficiency(language.rating)}
                      </p>
                    </div>
                    <div>
          ...
          <div id="technologies" className="first_card">
            <div className="card_title_container">
              ...
              >
                <path
                  d="M17.9 11.3C18 10.8 18 10.4 18 10C18 9.6 18 9.2 17.9 8.7L19.8 7L17.5 3L15.1 3.8C14.4 3.3 13.7 2.8 12.9 2.5L12.3 0H7.70001L7.20001 2.5C6.30001 2.8 5.60001 3.3 4.90001 3.8L2.50001 3L0.200012 7L2.10001 8.7C2.00001 9.2 2.00001 9.6 2.00001 10C2.00001 10.4 2.00001 10.8 2.10001 11.3L0.200012 13L2.50001 17L4.90001 16.2C5.60001 16.7 6.30001 17.2 7.10001 17.5L7.70001 20H12.4L12.9 17.5C13.7 17.2 14.5 16.8 15.1 16.2L17.5 17L19.8 13L17.9 11.3ZM10 14C7.80001 14 6.00001 12.2 6.00001 10C6.00001 7.8 7.80001 6 10 6C12.2 6 14 7.8 14 10C14 12.2 12.2 14 10 14Z"
                  fill="#091133"
                />
              </svg>
            ...
            <div className="technologies_container">
              ...
              <div className="technologies_text_container">
                {Object.keys(Data.technologies.Frameworks).map(key => {
                  ...
                  return (
                    <span className="technologies_text" key={key}>
                      {framework.name}
                    </span>
                  )
                })}
          ...
          <div id="education" className="first_card">
            <div className="card_title_container">
              ...
              >
                <path
                  d="M21.9545 4.52813L23 4.15078L11.5 0L0 4.15081L11.5 8.30155L20.3864 5.09415V7.58054C20.2242 7.71219 20.125 7.88432 20.125 8.07305C20.125 8.48501 20.594 8.82016 21.1705 8.82016C21.7469 8.82016 22.2159 8.48501 22.2159 8.07305C22.2159 7.88429 22.1167 7.71219 21.9546 7.58054V4.52813H21.9545Z"
                  fill="black"
                />
                <path
                  d="M11.5 9.55706L4.18176 6.91565V12.3689C4.18176 13.813 7.45823 14.9837 11.4999 14.9837C15.5417 14.9837 18.8181 13.813 18.8181 12.3689V6.91565L11.5 9.55706Z"
                  fill="black"
                />
              </svg>
            ...
            <div>
              <div className="university_container">
                <div className="university_box">
                  ...
                  <div className="university_card">
                    <span className="university_name">
                      {Data.education.id1.institution}
                    </span>
                    <p className="language_confidence_level">
                      {Data.education.id1.degree}
                    </p>
                    <p className="language_confidence_level">
                      {Data.education.id1.date}
                    </p>
                  </div>
                </div>
                ...
                <div className="university_box">
                  ...
                  <div className="university_card">
                    <span className="university_name">
                      {Data.education.id2.institution}
                    </span>
                    <p className="language_confidence_level">
                      {Data.education.id2.degree}
                    </p>
                    <p className="language_confidence_level">
                      {Data.education.id2.date}
                    </p>
                  </div>
                </div>
                ...
                <div className="university_box">
                  ...
                  <div className="university_card">
                    <span className="university_name">
                      {Data.education.id3.institution}
                    </span>
                    <p className="language_confidence_level">
                      {Data.education.id3.degree}
                    </p>
                    <p className="language_confidence_level">
                      {Data.education.id3.date}
                    </p>
                  </div>
                </div>
              </div>
